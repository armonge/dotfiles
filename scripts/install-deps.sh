...
declare -a MACOS_DEV_TOOLS=(awscli aws-iam-authenticator the_silver_searcher fd django-completion podman httpie chafa pgformatter jd composer)
declare -a MACOS_EXTRA_TOOLS=(git-absorb duckdb difftastic tectonic imagemagick ghostscript pngpaste git-spice)
